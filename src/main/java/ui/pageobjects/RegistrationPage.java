...
import static ui.pageobjects.LoginPage.LOGIN_BUTTON;

public class RegistrationPage extends Page {

    // Поля формы "Регистрация"
    public static final By NAME_INPUT = By.xpath(".//label[text()='Имя']/parent::*/input");
    ...
    public static final By INCORRECT_PASSWORD_ERROR = By.xpath(".//p[text()='Некорректный пароль']");
