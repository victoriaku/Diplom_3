...
public abstract class Page {
    ...
    //Хедер
    protected static final By LOGO_LINK = By.xpath(".//div[@class='AppHeader_header__logo__2D0X2']/a");
    protected static final By CONSTRUCTOR_LINK = By.xpath(".//p[text()='Конструктор']/parent::a");
    protected static final By ACCOUNT_LINK = By.linkText("Личный Кабинет");
